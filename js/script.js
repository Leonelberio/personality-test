...
const displaySelectedAnswer = (answer) => {
  if (answer === 0) {
    document.getElementById("div-ans-a").style.border = "2px solid darkgoldenrod";
  } else if (answer === 1) {
    document.getElementById("div-ans-b").style.border = "2px solid darkgoldenrod";
  } else if (answer === 2) {
    document.getElementById("div-ans-c").style.border = "2px solid darkgoldenrod";
  } else {
    document.getElementById("div-ans-d").style.border = "2px solid darkgoldenrod";
  }
};
  ...
  switch (chosenAnswer) {
    case 0:
      element = `<div id="question-count">Question <span id="counter"></span>${index}/5</div>
        ...
        <div class="ans" id="div-ans-a" style="border: 2px solid darkgoldenrod">
          <span class="my-alpha">A</span><span class="my-question" id="ans-a">${questionObj.answers[0].text}</span>
        </div>
        <div class="ans" id="div-ans-b">
          <span class="my-alpha">B</span><span class="my-question" id="ans-b">${questionObj.answers[1].text}</span>
        </div>
        <div class="ans" id="div-ans-c">
          <span class="my-alpha">C</span><span class="my-question" id="ans-c">${questionObj.answers[2].text}</span>
        </div>
        <div class="ans" id="div-ans-d" style="margin-bottom: 40px">
          <span class="my-alpha">D</span><span class="my-question" id="ans-d">${questionObj.answers[3].text}</span>
        </div>
        `;
      break;
    case 1:
      element = `<div id="question-count">Question <span id="counter"></span>${index}/5</div>
        ...
        <div class="ans" id="div-ans-b" style="pointer-events: none; border: 2px solid darkgoldenrod">
          <span class="my-alpha">B</span><span class="my-question" id="ans-b">${questionObj.answers[1].text}</span>
        </div>
        <div class="ans" id="div-ans-c" >
          <span class="my-alpha">C</span><span class="my-question" id="ans-c">${questionObj.answers[2].text}</span>
      ...
      break;
    case 2:
      element = `<div id="question-count">Question <span class="my-question" id="counter"></span>${index}/5</div>
        <div id="question">${questionObj.question}</div>
        <div class="ans" id="div-ans-a">
          <span class="my-alpha">A</span><span class="my-question" id="ans-a">${questionObj.answers[0].text}</span>
        </div>
        ...
        <div class="ans" id="div-ans-c" style="border: 2px solid darkgoldenrod">
          <span class="my-alpha">C</span><span class="my-question" id="ans-c">${questionObj.answers[2].text}</span>
        </div>
    ...
    case 3:
      element = `<div id="question-count">Question <span id="counter"></span>${index}/5</div>
        ...
        <div class="ans" id="div-ans-d" style="margin-bottom: 40px; border: 2px solid darkgoldenrod">
          <span class="my-alpha">D</span><span class="my-question" id="ans-d">${questionObj.answers[3].text}</span>
        </div>
        `;
      break;
